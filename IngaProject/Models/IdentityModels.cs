...
namespace IngaProject.Models
{
    ...
    {
        private ObservableCollection<SourceFile> _userfiles { get; set; }
        public ObservableCollection<SourceFile> UserFiles { get { return _userfiles; } set { _userfiles = value; OnPropertyChanged("File"); } }
